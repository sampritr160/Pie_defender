...
## How to Run the Project (Three-Terminal Workflow)

This project is executed using **three separate terminals**, each with a specific role.  
...
This terminal must remain running at all times.
...
Terminal 3 → Monitor flow rules (optional)

The controller must always be started before Mininet.
